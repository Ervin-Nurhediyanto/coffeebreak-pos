...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  <div class="sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <h2 class="mt-5 text-center text-2xl/9 font-bold tracking-tight text-white">Sign in to your account</h2>
  </div>
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-10 text-center text-sm/6 text-gray-500">
      Not a member?
      <a href="{{route('user.create')}}" class="font-semibold text-indigo-600 hover:text-indigo-500">Register now</a>
